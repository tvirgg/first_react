...
function useMultiselectData(value = EMPTY_ARRAY, data, accessors, filter, searchTerm) {
  data = useMemo(() => data.filter(i => !value.some(v => accessors.matches(i, v))), [data, value, accessors]);
...
const Multiselect = /*#__PURE__*/React.forwardRef(function Multiselect(_ref, outerRef) {
  let {
    ...
    messages: userMessages
      ...
      elementProps = _objectWithoutPropertiesLoose(_ref, ["dataKey", "textField", "autoFocus", "id", "value", "defaultValue", "onChange", "open", "defaultOpen", "onToggle", "focusFirstItem", "searchTerm", "defaultSearchTerm", "onSearch", "filter", "allowCreate", "className", "containerClassName", "placeholder", "busy", "disabled", "readOnly", "selectIcon", "clearTagIcon", "busySpinner", "dropUp", "tabIndex", "popupTransition", "showPlaceholderWithValues", "onSelect", "onCreate", "onKeyDown", "onBlur", "onFocus", "inputProps", "listProps", "renderListItem", "renderListGroup", "renderTagValue", "optionComponent", "tagOptionComponent", "groupBy", "listComponent", "popupComponent", "data", "messages"]);
  ...
  return /*#__PURE__*/React.createElement(Widget, _extends({}, elementProps, {
    ...
    "aria-atomic": "true",
    "aria-relevant": "all"
  }, focused && (dataItems.length ? messages.selectedItems(itemLabels) : messages.noneSelected())), /*#__PURE__*/React.createElement(WidgetPicker, {
    onClick: handleClick,
